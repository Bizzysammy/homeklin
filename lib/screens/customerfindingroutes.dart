...
import '../vandriverscreens/vanprovider.dart';

class Customerfindroutes extends StatefulWidget {
  const Customerfindroutes  ({Key? key}) : super(key: key);
  static const String id = 'bin_collection';

  @override
  State<Customerfindroutes > createState() => _CustomerfindroutesState();
}

class _CustomerfindroutesState extends State<Customerfindroutes > {
  ...
  void _searchPlace(String query) async {
    ...
    if (await canLaunchUrl(googleMapsUrl.toString() as Uri)) {
      await launchUrl(googleMapsUrl.toString() as Uri);
    } else {
  ...
  Widget build(BuildContext context) {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              onSubmitted: (value) {
                                _searchPlace(
                                    value); // Function to handle navigation to Google Maps
                              },
                            ),
                          ),
                        ],
    ...
    builder: (consumerContext, locationProvider, child) {
    return Column(
    children: <Widget>[
    Expanded(
    child: GoogleMap(
