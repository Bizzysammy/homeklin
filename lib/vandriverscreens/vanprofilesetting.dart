...
class Vanprofilesetting extends StatefulWidget {
  const Vanprofilesetting({Key? key}) : super(key: key);

  @override
  State<Vanprofilesetting> createState() => _VanprofilesettingState();
}

class _VanprofilesettingState extends State<Vanprofilesetting> {
  ...
  Future<void> _loadUserData() async {
    ...
    await _firestore.collection('Van Drivers').doc(_user!.uid).get();
  ...
  Future<void> _loadProfileImage() async {
    final userDoc = await _firestore.collection('Van Drivers').doc(_user!.uid).get();
