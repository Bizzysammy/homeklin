...
class FindRoutes extends StatefulWidget {
  const FindRoutes({Key? key}) : super(key: key);
  static const String id = 'bin_collection';

  @override
  State<FindRoutes> createState() => _FindRoutesState();
}

class _FindRoutesState extends State<FindRoutes> {
                            ...
                            children: <Widget>[
                              Expanded(
                                child: GoogleMap(
                                  ...
                                  onTap: (position) {
                                    _selectLocation(position); // Function to select a location on the map
                                  },
                                ),
                              ),
                            ],
